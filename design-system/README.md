...
- **`../design-system.html`** — 儀表板，掛在工作台「文件與驗收」群組下，與其他工具一樣有側邊導覽。每個客戶一張資訊卡：品牌深色底上的 Logo、品牌色標、元件／卡片數量與品牌字體。
- **`<客戶>/index.html`** — 該客戶的詳細頁：brand / colors / type / spacing / components 卡片縮圖、UI kit 入口、README 與 tokens 快速連結、即時搜尋，並可返回儀表板。
